...
import static com.kfast.init.DriverManager.env;
...
public class CustomReporter implements IExecutionListener, IReporter {
	...
	private void startResultSummaryTable(String style) {
		...
		m_out.println("<tr><td colspan='6'>Overall test suite completion: <b>" + Time
				...
				+ getProperty(CONFIG_PROPERTIES, BROWSER) + " " + getProperty(CONFIG_PROPERTIES, VERSION)
				+ "</b><br/>OS: <b>" + System.getProperty("os.name") + "</b><br/>Tested URL: <b>"
				+ getProperty(CONFIG_PROPERTIES, URL) + "</b> <br/></td></tr>");
	...
	public void onExecutionFinish() {
		if (env.equals("local")) {
			try {
				new MailUtils().sendMail("test@kiwiqa.com", "password@kiwiqa.com",
						"test-output/emailable-summary-report.html");

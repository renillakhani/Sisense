...
import static com.kfast.api.BaseAPI.env;
...
import com.kfast.utils.MailUtils;

import jakarta.mail.MessagingException;

@SuppressWarnings(value = { "unused" })
public class CustomReporterForAPI implements IExecutionListener, IReporter {

	private static final Logger L = Logger.getLogger(CustomReporterForAPI.class);
	...
	private PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(
				new BufferedWriter(new FileWriter(new File(outdir, "emailable-api-summary-report" + ".html"))));
	}
	...
	private void startResultSummaryTable(String style) {
		...
		m_out.println("<tr><td bgcolor='white' colspan='6'> <table border='0' width='100%' bgcolor='#e6f7ff'><tr>"
				...
				+ "<center><img width='290px' src='https://www.kiwiqa.com/wp-content/uploads/2021/08/kiwiqa-logo.png'/></center>"
				+ "</td><td ><center><font color='#008bcc'><b><h1>Test Cases Analysis</h1></b></font></center></td> "
				+ "<td width='25%' bgcolor='white'>" + "<center><img width='290px' src=''/></center></td> "
				+ "</tr></table> </td></tr>");
		m_out.println("<tr><td colspan='6'>Overall test suite completion: <b>" + Time
				+ " minutes</b><br/> Date and Time of Run: <b>" + sdf.format(date) + "</b><br/>OS: <b>"
				+ System.getProperty("os.name") + "</b><br/>Tested URL: <b>" + getProperty(CONFIG_PROPERTIES, BASE_URL)
				+ "</b> <br/></td></tr>");
	...
	private Collection<ITestNGMethod> getMethodSet(IResultMap tests, ISuite suite) {
		...
		// Add all the methods that weren't invoked (e.g. skipped) that we haven't added
		// yet
	...
	private void endHtml(PrintWriter out) {
		out.println("""
				<tr bgcolor='SkyBlue'><td align='right' colspan='6'><center><b><i>Customized by KiwiQA</i><b></center></td></tr>
				</table>
				</body>
				</html>""");
	}
		...
		if (env.equals("local")) {
			try {
				new MailUtils().sendMail("badal.shah@kiwiqa.com", "badal.shah@kiwiqa.com",
						"test-output/emailable-api-summary-report.html");
